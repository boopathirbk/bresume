...
Over the past 7+ years I've grown from IT support into leading full IT operations across 4 branches — serving as Microsoft 365 Global Admin, administering Azure Active Directory, SharePoint, OneDrive, Cloudflare, DNS, and network security.
    ...
    experience: [
        ...
        },
        {
            ...
            description: [
                ...
                "Organisation-wide IT support — OS troubleshooting, hardware, network, application errors.",
                "Cloudflare CDN, SMTP, DNS configuration.",
                "WordPress websites on Dreamhost, Hostinger, GoDaddy."
            ]
        },
        {
            ...
            description: [
                "Full-stack WordPress websites for international clients.",
                "Brand graphics, logos, video content."
            ]
        },
        {
            role: "Domain & Hosting Support (Part-time)",
            company: "USA Web Buzi LLC",
            period: "December 2017 - March 2021",
            description: [
                "Remote support for US clients — domain, hosting, cPanel, WordPress, migrations."
            ]
        }
    ],
    projects: [
    ...
    education: [
        {
            ...
            school: "Bannari Amman Institute of Technology, Anna University",
            period: "2015 - 2019"
        },
        {
            degree: "Japanese Language CJAT1",
            school: "Hayakawa Japanese Language School",
            period: "2019 - 2020"
        }
    ],
    certifications: [
        "AWS Certified Cloud Practitioner — Jan 2022",
        "Microsoft Certified: Azure Fundamentals (AZ-900) — Dec 2021",
        "Microsoft 365 Certified: Fundamentals — Nov 2021",
        "Linux Essentials: 010 (LPI) — Nov 2021",
        "Japanese Language Proficiency N5 (JLPT) — Aug 2022",
